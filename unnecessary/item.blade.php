        ...
        <div class="wrap_article size_article700">
            ...
            <div>
                <div class="wrap_name_section">
                    @if(isset(Auth::user()->worker) && Auth::user()->worker->is($worker))
                        <span class="name_section" data-content="part_proposed_jobs">Предложенные задания (1)</span>
            ...
            @if(isset(Auth::user()->worker) && Auth::user()->worker->is($worker))
                ...
                <div class="part part_hired_jobs show_parte tab" style="display:none;">
                    <div class="cards">
            ...
            @else
                <div class="part part_your_job show_parte tab" style="display:none;">
                    <div class="cards">
                        <h3>Моё задание</h3>
                    </div>
...
{{--            @endauth--}}
    ...
    @endauth
    <div class="most" id="app">
        <test-component></test-component>
    </div>



    <script src="{{ mix('js/worker/item_worker.js') }}">
        let component = new Vue({
            el: '.most',
            data: {
                message: 'that they do it would be '
            }
        })
    </script>
@endsection
