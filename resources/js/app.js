...
Vue.component('job-preview-component', require('./components/JobPreviewComponent.vue').default);
...
Vue.component('popup-select-job-component', require('./components/PopupSelectJobComponent.vue').default);
