...
function getProposedJob(url, nameClass) {
  var form, query;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function getProposedJob$(_context) {
    while (1) {
        ...
        case 0:
          ...
          query = fetch(url, {
            ...
            if (y.length > 0) {
              ...
              var span = '<span class="part__warning_text">Нет заданий.</span>';
...
function getHiredJob() {
  ...
  form.append('worker_id', '1');
  var query = fetch('/get_hired_jobs', {
    method: 'post',
    headers: {
      'X-CSRF-TOKEN': _common_get_csrf__WEBPACK_IMPORTED_MODULE_1__["default"]
    },
    ...
    if (y.length > 0) {
      ...
      var span = '<span class="part__warning_text">Нет принятых заданий.</span>';
...
function html(item) {
  return "\n        <div class=\"card\">\n            <div class=\"data data-height75\">\n                <div class=\"data__topRow\">\n                    <a href=\"\" class=\"topRow__name\">".concat(item.title, "</a>\n                    <p class=\"topRow__price\">\u0446\u0435\u043D\u0430: <span>").concat(item.price, "</span>\u0440.</p>\n                </div>\n                <p class=\"data__description\">").concat(item.description.substr(0, 88), "</p>\n                <div class=\"data__bottomRow\">\n                    <p class=\"bottomRow__create\">\u0441\u043E\u0437\u0434\u0430\u043D\u0438\u0435: ").concat(item.created_at, "</p>\n                    <a href=\"workrus.loc/job/").concat(item.id, "\" class=\"bottomRow__detailed\">\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n                </div>\n            </div>\n        </div>\n    ");
...
function ff() {
  var proposedJobBtn = document.querySelector('.proposed_job_btn');
  proposedJobBtn.addEventListener('click', function _callee() {
