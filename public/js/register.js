...
/***/ "./resources/js/auth/register/cancel_register.js":
/*!*******************************************************!*\
  !*** ./resources/js/auth/register/cancel_register.js ***!
  \*******************************************************/
...
/* harmony import */ var _common_hide_verify_phone__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../common/hide_verify_phone */ "./resources/js/common/hide_verify_phone.js");
/* harmony import */ var _common_ajaxPOST__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/ajaxPOST */ "./resources/js/common/ajaxPOST.js");



var inputPassword = document.querySelectorAll('.form__input[type=password]');
function _callee() {
  var response;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_ajaxPOST__WEBPACK_IMPORTED_MODULE_2__["default"])('/register/de_registration'));

        case 2:
          response = _context.sent;
          _context.next = 5;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_hide_verify_phone__WEBPACK_IMPORTED_MODULE_1__["default"])());
...
/***/ "./resources/js/auth/register/sing_up.js":
/*!***********************************************!*\
  !*** ./resources/js/auth/register/sing_up.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var _common_timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/timer */ "./resources/js/common/timer.js");
/* harmony import */ var _common_errors_show_errors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../common/errors/show_errors */ "./resources/js/common/errors/show_errors.js");
...
/* harmony import */ var _common_errors_hide_errors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../common/errors/hide_errors */ "./resources/js/common/errors/hide_errors.js");
...
var errorsRegister = document.querySelector('.errors_register');
function _callee() {
  var result, response, elem1, elem2, timer;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_ajaxPOST__WEBPACK_IMPORTED_MODULE_1__["default"])('/register', document.forms.form_register));
        ...
        case 2:
          ...
          if (response.time) {
            ...
            timer = new _common_timer__WEBPACK_IMPORTED_MODULE_2__["default"](response.time, elem1, elem2);
            timer.start();
            Object(_common_show_verify_phone__WEBPACK_IMPORTED_MODULE_4__["default"])();
            Object(_common_errors_hide_errors__WEBPACK_IMPORTED_MODULE_5__["default"])(errorsRegister);
          }

          if (response.valid) {
            document.querySelector('input[name=phone]').focus();
            Object(_common_errors_show_errors__WEBPACK_IMPORTED_MODULE_3__["default"])(response.valid, errorsRegister);
          }
...
/***/ "./resources/js/entry_points/register.js":
/*!***********************************************!*\
  !*** ./resources/js/entry_points/register.js ***!
  \***********************************************/
/*! no exports provided */
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _auth_register_sing_up__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../auth/register/sing_up */ "./resources/js/auth/register/sing_up.js");
/* harmony import */ var _common_verify_phone__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common/verify_phone */ "./resources/js/common/verify_phone.js");
/* harmony import */ var _auth_register_cancel_register__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth/register/cancel_register */ "./resources/js/auth/register/cancel_register.js");
/* harmony import */ var _common_resend_verify_code__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../common/resend_verify_code */ "./resources/js/common/resend_verify_code.js");





document.querySelector('input[value=Зарегистрироваться').addEventListener('click', function _callee(e) {
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          _context.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_auth_register_sing_up__WEBPACK_IMPORTED_MODULE_1__["default"])());
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          e.preventDefault();
          _context2.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_verify_phone__WEBPACK_IMPORTED_MODULE_2__["default"])('/register/verify_phone', document.forms.verify_phone));
...
document.querySelector('.verify_phone_popup .cancel_btn').addEventListener('click', function _callee3(e) {
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          e.preventDefault();
          _context3.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_auth_register_cancel_register__WEBPACK_IMPORTED_MODULE_3__["default"])());
...
document.querySelector('.verify_phone_popup .resend_code_btn').addEventListener('click', function _callee4(e) {
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          e.preventDefault();
          _context4.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_resend_verify_code__WEBPACK_IMPORTED_MODULE_4__["default"])('/register/resend_verify_code'));
...
/***/ 1:
/*!*****************************************************!*\
  !*** multi ./resources/js/entry_points/register.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\OSPanel\domains\work\resources\js\entry_points\register.js */"./resources/js/entry_points/register.js");
