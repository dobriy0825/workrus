...
/***/ "./resources/js/create_job/cal.js":
/*!****************************************!*\
  !*** ./resources/js/create_job/cal.js ***!
  \****************************************/
/*! exports provided: default */
...
function Calendar() {
  ...
  this.renderDays = function (numbers) {
    var numberOfDays = new Date(this.currentYear, this.currentMonth, 0).getDate();
    var dayOfTheOfDays = new Date(this.currentYear, this.currentMonth, 1).getDay();

    if (dayOfTheOfDays == 0) {
      dayOfTheOfDays = 7;
    }

    var g = numberOfDays - dayOfTheOfDays;

    for (var i = g + 2; i <= numberOfDays; i++) {
      var number = document.createElement('div');
      number.classList.add('calendar_number', 'calendar_number__last_day'); //number.append(i);

      numbers.append(number);
    }

    var numberOfDaysInCurrentMonth = new Date(this.currentYear, this.currentMonth + 1, 0).getDate();

    for (var _i = 1; _i <= numberOfDaysInCurrentMonth; _i++) {
      var day = new Date(this.currentYear, this.currentMonth, _i).getDay();

      var _number = document.createElement('div');

      _number.classList.add('calendar_number');

      this.calculateWeekend(day, _number);
      this.pastDays(_i, _number);
      this.remainingDay(_i, _number);
  ...
  this.html = function (node) {
    ...
    var wrapMonthYear = document.createElement('div');
  ...
  this.overlay = function () {
    var overlayFix = document.createElement('div');
    ...
    overlayFix.style.width = '100%'; //overlayFix.style.backgroundColor = 'black';
...
/***/ "./resources/js/entry_points/job/create_job.js":
/*!*****************************************************!*\
  !*** ./resources/js/entry_points/job/create_job.js ***!
  \*****************************************************/
/*! no exports provided */
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _common_ajaxGET__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../common/ajaxGET */ "./resources/js/common/ajaxGET.js");
/* harmony import */ var _common_renderList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/renderList */ "./resources/js/common/renderList.js");
/* harmony import */ var _common_renderSubList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../common/renderSubList */ "./resources/js/common/renderSubList.js");
/* harmony import */ var _common_active_item__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../common/active_item */ "./resources/js/common/active_item.js");
/* harmony import */ var _common_get_items__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../common/get_items */ "./resources/js/common/get_items.js");
/* harmony import */ var _common_back_btn_for_mobile__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../common/back_btn_for_mobile */ "./resources/js/common/back_btn_for_mobile.js");
/* harmony import */ var _create_job_cal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../create_job/cal */ "./resources/js/create_job/cal.js");
/* harmony import */ var _common_ajaxPOST__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/ajaxPOST */ "./resources/js/common/ajaxPOST.js");
/* harmony import */ var _common_get_csrf__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../common/get_csrf */ "./resources/js/common/get_csrf.js");
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          Object(_common_back_btn_for_mobile__WEBPACK_IMPORTED_MODULE_6__["default"])(wrapSubList, backBtnForMobile);
          inputSearch.value = '';
          ...
          _context.next = 7;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_ajaxGET__WEBPACK_IMPORTED_MODULE_1__["default"])('/job/create/regions'));

        case 7:
          _regions = _context.sent;
          Object(_common_renderList__WEBPACK_IMPORTED_MODULE_2__["default"])(elementForRegions, _regions);
          _cities = _regions[0].city;
          Object(_common_renderSubList__WEBPACK_IMPORTED_MODULE_3__["default"])(elementForCities, _cities, 1);
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              Object(_common_active_item__WEBPACK_IMPORTED_MODULE_4__["default"])(regions, this);
              id = item.getAttribute('data-region');
              _context2.next = 4;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_get_items__WEBPACK_IMPORTED_MODULE_5__["default"])(id, '/job/create/cities'));

            case 4:
              cities = _context2.sent;
              Object(_common_renderSubList__WEBPACK_IMPORTED_MODULE_3__["default"])(elementForCities, cities, id);
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          _context3.next = 12;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(fetch('/job/create/city_search', {
            method: 'post',
            headers: {
              'X-CSRF-TOKEN': _common_get_csrf__WEBPACK_IMPORTED_MODULE_9__["default"]
            },
            body: data
          }));
...
var showTypJobBtn = document.querySelector('.btn_show_typeJob__items');
var elementForCategories = document.querySelector('.types_of_jobs_selection_popup .wrap_title_parentlist .select_value__list');
var elementForSubCategories = document.querySelector('.types_of_jobs_selection_popup .wrap_title_sublist .select_value__list');
var wrapParentListTypeJob = document.querySelector('.types_of_jobs_selection_popup .wrap_title_parentlist');
var wrapSubListTypeJob = document.querySelector('.types_of_jobs_selection_popup .wrap_title_sublist');
var backBtnForMobileTypeJob = document.querySelector('.types_of_jobs_selection_popup .select_value__btn_back');
var itemCategory; //= document.querySelector('.types_of_jobs_selection_popup .wrap_title_parentlist .select_value__list_item');

var typeOfJobsSelection = document.querySelector('.types_of_jobs_selection_popup');
showTypJobBtn.addEventListener('click', function _callee4() {
  var categories;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          Object(_common_back_btn_for_mobile__WEBPACK_IMPORTED_MODULE_6__["default"])(wrapSubListTypeJob, backBtnForMobileTypeJob);
          ...
          _context4.next = 4;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_ajaxGET__WEBPACK_IMPORTED_MODULE_1__["default"])('/job/create/categories'));

        case 4:
          categories = _context4.sent;
          Object(_common_renderList__WEBPACK_IMPORTED_MODULE_2__["default"])(elementForCategories, categories); //let subCategories = categories[0].sub_categories;
...
document.querySelector('.types_of_jobs_selection_popup .select_value__icon_close').addEventListener('click', function () {
  typeOfJobsSelection.style.display = 'none'; //showTypJobBtn.innerHTML = 'Выбрать вид задания';
});
document.querySelector('.types_of_jobs_selection_popup .header-for-mobile').addEventListener('click', function (e) {
  var target = e.target;
...
var calendar = new _create_job_cal__WEBPACK_IMPORTED_MODULE_7__["default"]();
...
document.querySelectorAll('.wrap_date').forEach(function (item) {
  item.addEventListener('click', function (e) {
    ...
    if (element.classList.contains('remaining_days')) {
      ...
      var datepicker = item.children[1];
...
var selectCategory = document.querySelector('.select_category');
var selectSubCategory = document.querySelector('.select_sub_category');
selectCategory.addEventListener('change', function _callee5() {
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          console.log(value);
          _context5.next = 4;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_common_get_items__WEBPACK_IMPORTED_MODULE_5__["default"])(value, '/job/create/sub_categories'));

        case 4:
          subCategories = _context5.sent;
          //console.log(subCategories)
...
var input = document.querySelector('.date_time__time');

/***/ }),

/***/ 8:
/*!***********************************************************!*\
  !*** multi ./resources/js/entry_points/job/create_job.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\OSPanel\domains\work\resources\js\entry_points\job\create_job.js */"./resources/js/entry_points/job/create_job.js");
